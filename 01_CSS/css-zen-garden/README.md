...
## Aufgabenstellung
Erstellen Sie eine eigene Design-Umsetzung für die vorgegebene HTML-Struktur des CSS Zen Garden. **Verändern Sie dabei nicht das HTML File**, sondern arbeiten Sie nur im style.css.

Lassen Sie Ihrer Kreativität freien Lauf und gestalten Sie die Seite. Probieren Sie Pseudo-Klassen, Transitions uvm. aus, verwenden Sie neuen CSS-Syntax, den Sie bisher nicht kannten.
